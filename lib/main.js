...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            core.debug(`Publishing directory '${publish_dir}'`); // debug is only output if you set the secret `ACTIONS_RUNNER_DEBUG` to true
            const awsCredentials = {
                AWS_ACCESS_KEY_ID,
                AWS_SECRET_ACCESS_KEY,
            };
            execCDK("bootstrap", Object.assign(Object.assign({}, awsCredentials), { CDK_DEPLOY_REGION: "us-east-1", FOLDER: publish_dir }));
            execCDK("deploy --require-approval never", Object.assign(Object.assign({}, awsCredentials), { FOLDER: publish_dir }));
        }
        catch (error) {
